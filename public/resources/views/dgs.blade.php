...
<body>
	...
	<!-- navbar -->
    <nav>
		<div class="logoo"><a href="/ogrenci_anamenu">DGS BAŞVURUSU</a></div>
		<ul>
			<li>
	...
	<div class="dgs">
		<section class="flex-class">
			<div class="content">
				<div class="container">
					<p>DGS Başvuruları ÖSYM Sitesi Üzerinden Yapılmaktadır</p>
					<a href="https://ais.osym.gov.tr" target="_blank">
						<button id="DGS-button" class="btn">ÖSYM</button>
					</a>
...
<!-- footer -->
		<div class="fContent" style="margin-top: 300px;">
			<div class="sutun">
				<h3>Bize Ulaşın</h3>
				<p class="divider flex-class"><span></span></p>
				<ul class="socials">
